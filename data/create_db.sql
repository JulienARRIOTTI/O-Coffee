DROP TABLE IF EXISTS "coffee_has_flavor";
...
CREATE TABLE
  "coffee_has_flavor" (
    ...
    "flavor_id" INT REFERENCES "flavor" ("id")
  );

  -- Requêtes SQL générées automatiquement pour O'Coffee
-- Généré le : 24/09/2025 13:55:33
...
-- Insertion des cafés
INSERT INTO coffee (name, description, reference, country_id, price, available) VALUES
...
INSERT INTO coffee_has_flavor (coffee_id, flavor_id) VALUES
    ((SELECT id FROM coffee WHERE reference = '100955890'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '100955890'), (SELECT id FROM flavor WHERE name = 'Épicé')),
    ((SELECT id FROM coffee WHERE reference = '100955894'), (SELECT id FROM flavor WHERE name = 'Acide')),
    ((SELECT id FROM coffee WHERE reference = '105589090'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '105589090'), (SELECT id FROM flavor WHERE name = 'Fruité')),
    ((SELECT id FROM coffee WHERE reference = '134009550'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '256505890'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '295432730'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '295432730'), (SELECT id FROM flavor WHERE name = 'Acide')),
    ((SELECT id FROM coffee WHERE reference = '302932754'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '327302954'), (SELECT id FROM flavor WHERE name = 'Acide')),
    ((SELECT id FROM coffee WHERE reference = '549549090'), (SELECT id FROM flavor WHERE name = 'Épicé')),
    ((SELECT id FROM coffee WHERE reference = '582954954'), (SELECT id FROM flavor WHERE name = 'Fruité')),
    ((SELECT id FROM coffee WHERE reference = '582954954'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '589100954'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '650753915'), (SELECT id FROM flavor WHERE name = 'Fruité')),
    ((SELECT id FROM coffee WHERE reference = '795501340'), (SELECT id FROM flavor WHERE name = 'Fruité')),
    ((SELECT id FROM coffee WHERE reference = '954589100'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '954589100'), (SELECT id FROM flavor WHERE name = 'Chocolaté')),
    ((SELECT id FROM coffee WHERE reference = '958090105'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '691550753'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '691550753'), (SELECT id FROM flavor WHERE name = 'Fruité'));-- Requêtes SQL générées automatiquement pour O'Coffee
-- Généré le : 24/09/2025 13:55:33
...
INSERT INTO coffee_has_flavor (coffee_id, flavor_id) VALUES
    ...
    ((SELECT id FROM coffee WHERE reference = '958090105'), (SELECT id FROM flavor WHERE name = 'Doux')),
    ((SELECT id FROM coffee WHERE reference = '691550753'), (SELECT id FROM flavor WHERE name = 'Corsé')),
    ((SELECT id FROM coffee WHERE reference = '691550753'), (SELECT id FROM flavor WHERE name = 'Fruité'));